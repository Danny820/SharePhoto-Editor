...
public class PalPicDBHandler {
    ...
    public void insert(Sticker sticker) {
        ...
        // Inserting Row
        db.insert(Sticker.TABLE, null, values);
    }
    ...
    public void delete(String id) {
        ...
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        db.delete(Sticker.TABLE, Sticker.KEY_ID + "='" + id + "'", null);
    }
    ...
    public void update(Sticker sticker) {
        ...
        db.update(Sticker.TABLE, values, Sticker.KEY_ID + "='" + sticker.id + "'", null);
    }
    ...
    public void insertToRecent(Sticker sticker) {
        ...
        // Inserting Row
        db.insert(RECENT_TABLE, null, values);
    }
    ...
    public void deleteRecent(String id) {
        ...
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        db.delete(RECENT_TABLE, Sticker.KEY_ID + "='" + id + "'", null);
    }
